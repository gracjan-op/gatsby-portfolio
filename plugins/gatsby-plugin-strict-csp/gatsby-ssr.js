...
exports.onPreRenderHTML = (
  ...
  let CSP = `base-uri 'none'; default-src 'self'; script-src https://www.google-analytics.com 'self'${scriptHashes}; style-src 'self' 'unsafe-inline'; object-src 'none'; form-action 'self'; font-src self data:; connect-src 'self'; img-src 'self' https://www.google-analytics.com data:;`
